...
public class AlfredQuotes {
    ...
    */
    public String guestGreeting(String name, String dayPeriod) {
        ...
        String guestGreeting = String.format("Hello! %s, Good %s !", "Beth", "evening" );
    ...
    */
    public String dateAnnouncement() {
        Date date = new Date();
        String dateAnnouncement = String.format ("The current date is:" + date);
    ...
    */
    public String respondBeforeAlexis(String conversation) {
        String respondBeforeAlexis = String.format ("At your service. As you wish, naturally.");
        System.out.println(respondBeforeAlexis);
        return respondBeforeAlexis;
    }
    // NINJA BONUS
